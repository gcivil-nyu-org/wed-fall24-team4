...
def load_json_to_db(json_file_path):
    ...
    for entry in data:
        station = Station(
            ...
            station_id=int(entry['station_id']),  # Consider adding try-except for safety
            ...
            georeference_latitude=entry.get('georeference', {}).get('coordinates', [None, None])[1],
            georeference_longitude=entry.get('georeference', {}).get('coordinates', [None, None])[0],
