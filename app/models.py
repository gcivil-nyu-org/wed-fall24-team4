...
class Station(models.Model):
    ...
    north_direction_label = models.CharField(max_length=255, null=True, blank=True)  # Example: "Last Stop"
    south_direction_label = models.CharField(max_length=255, null=True, blank=True)  # Example: "Manhattan"
